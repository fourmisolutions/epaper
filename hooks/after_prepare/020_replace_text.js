...
if (rootdir) {
    var ourconfigfile = path.join(rootdir, "", "ionic.config.json");
    ...
    var filestoreplace = [
        // android
        "platforms/android/assets/www/js/constants.js",
        // ios
        "platforms/ios/www/js/constants.js",
    ];
    filestoreplace.forEach(function(val, index, array) {
        ...
        if (fs.existsSync(fullfilename)) {
            ...
            replace_string_in_file(fullfilename, 
                "http://localhost:8100/shapi-proxy", 
                configobj[target].apiendpoint);
